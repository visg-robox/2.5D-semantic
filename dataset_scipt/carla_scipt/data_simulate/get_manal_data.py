...
OFFSET_FRAME=60
START_POSITION=55
OUT_DIR='Data/pointnet_test/ver1.0_128line_0.1mplace_fov+-30/start_55'
WINDOW_WIDTH =1024
WINDOW_HEIGHT = 1024
...
def make_carla_settings(args):
    ...
    lidar = Lidar(Lidarname)
    lidar.set_position(3, 0, 1.1)  # (5,0,4)
...
class CarlaGame(object):
            ...
            for frame in range(0,FRAME):
                for event in pygame.event.get():
                    if event.type == pygame.QUIT:
                        return
                self._on_loop(frame,self._args)
                self._on_render()
        finally:
            pygame.quit()
    ...
    def _on_new_episode(self):
        ...
        self.client.start_episode(START_POSITION)     #124,62,2
        self._timer = Timer()
        self._is_on_reverse = False

    def _on_loop(self,frame,args):
        ...
        self._main_image = sensor_data.get('RGB/CameraF0', None)
...
def main():
    ...
    args.out_filename_format = OUT_DIR+'/{:s}/{:0>6d}'
