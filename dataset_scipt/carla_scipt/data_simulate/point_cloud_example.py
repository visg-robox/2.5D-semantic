        ...
        for frame in range(1, number_of_frames):
            ...
            if not frame % frame_step:
                ...
                point_cloud.save_to_disk(os.path.join(
                    output_folder,'pointcloud', '{:0>5}.ply'.format(frame))
                )

                posepath=os.path.join(output_folder,'pose', '{:0>5}.txt'.format(frame))
                folder = os.path.dirname(posepath)
                ...
                with open(posepath,'w') as fp:
                    ...
                    write_message = write_message.format(
                        ...
                        pos_z=measurements.player_measurements.transform.location.z,
